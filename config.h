...
static const char *inclight[]      = { "sh", "-c", "xbacklight -inc 1", NULL };
static const char *declight[]      = { "sh", "-c", "xbacklight -dec 1", NULL };
static const char *incvolume[]     = { "sh", "-c", "amixer set Master 1%+", NULL };
static const char *decvolume[]     = { "sh", "-c", "amixer set Master 1%-", NULL };
static const char *mutetoggle[]    = { "sh", "-c", "amixer set Master toggle", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F1,     spawn,          {.v = declight} },
	{ MODKEY,                       XK_F2,     spawn,          {.v = inclight} },
