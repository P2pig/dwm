...
static const char *pdfViwer[]           = { "sh", "-c", "evince", NULL };
static const char *boomer[]             = { "sh", "-c", "boomer", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,      XK_n,            spawn,          {.v = pdfViwer}        },
    { Mod4Mask,              XK_b,            spawn,          {.v = boomer}          },
